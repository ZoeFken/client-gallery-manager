...
CREATE TABLE `settings` (
  ...
  `setting_value` tinyint(2) NOT NULL DEFAULT '1',
  `setting_created_at` timestamp NULL DEFAULT '0000-00-00 00:00:00',
	`setting_updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `settings` (`setting_id`, `setting_name`, `setting_value`, `setting_created_at`, `setting_updated_at`) 
VALUES 	(1, 'download', 1, '2019-01-27 00:35:23', '0000-00-00 00:00:00'),
				(2, 'select', 1, '2019-01-27 00:35:23', '0000-00-00 00:00:00'),
				(3, 'store_full_size', 1, '2019-01-27 00:35:23', '0000-00-00 00:00:00'),
				(4, 'resize', 1, '2019-01-27 00:35:23', '0000-00-00 00:00:00'),
				(5, 'visitor', 1, '2019-01-27 00:35:23', '0000-00-00 00:00:00');
